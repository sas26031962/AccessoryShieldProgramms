...
Реализована дополнительная индикация времени
*********************************************************************/
...
//#define TITLE "Accelerometer v3.0.0"  // Начальный текст
#define TITLE "------* v3.0.0 *-----"   // Начальный текст
...
void loop() 
{
  ...
  display.clrScr();
  display.print(TITLE, LEFT, STRING_0);
  display.print(showTime(), LEFT, STRING_1);
...
String showTime()
{
  ...
  s += Clock.getDate();
  // Промежуток между индикацией даты и времени
  s += "   ";// 4 space
